...
class JadwalJumat : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.fragment_jadwaljumat)
        supportActionBar?.hide()

        val sessionManager = SessionManager.getInstance(this)

        val hariJumat: TextView = findViewById(R.id.hariJumat)
...
//            hariJumat.text = scheduleForFriday.day
...
//            hariJumat.text = noScheduleMessage
//        }
